                ...
                <div className="prose prose-invert max-w-none space-y-8">
                  <section>
                    ...
                    <p className="text-muted-foreground">
                      By accessing and using SUNBOT products and services, you accept and agree to be bound
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground">
                      Permission is granted to temporarily use SUNBOT products for personal, non-commercial
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground">
                      SUNBOT products come with a standard warranty period as specified in the product
                  ...
                  <section>
                    ...
                    <p className="text-muted-foreground">
                      In no event shall SUNBOT be liable for any damages arising out of the use or inability
