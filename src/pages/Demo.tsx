...
import { Zap, Users, Calendar, CheckCircle2, Monitor, Globe, Shield } from "lucide-react";
                ...
                <div className="lg:col-span-12 xl:col-span-5">
                  <ScrollReveal>
                    ...
                    <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 text-white leading-[1.1] tracking-tighter-custom uppercase">
                      ...
                      <span className="text-gradient italic font-medium">in action</span>
                    </h1>

                    <p className="text-base text-white/50 mb-10 leading-relaxed max-w-sm font-medium">
                      Get a personalized demonstration of our monitoring solutions tailored to your specific environmental challenges.
                    </p>

                    <div className="space-y-3">
                      {[
                        { icon: Zap, label: "Live", value: "Real-time Platform Walkthrough" },
                        { icon: Users, label: "Expert", value: "Consult with our Technical Team" },
                        { icon: Globe, label: "Global", value: "Solutions for every environment" }
                      ].map((item, i) => (
                        <motion.div
                          key={i}
                      ...
                      {isSuccess ? (
                        <div className="bg-[#0A0A0A] border border-white/5 p-8 md:p-10 rounded-[32px] shadow-2xl">
                          ...
                          >
                            ...
                            <p className="text-white/60">Our team will reach out to schedule your session within 24 hours.</p>
                          </motion.div>
                        </div>
                      ) : (
                        <StyledContactForm 
                          title="Schedule Your Session"
                          formSubtitle="Fill out the details below and we'll be in touch."
