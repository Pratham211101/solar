...
const downloadables = {
  brochures: [
    { title: "solar Company Brochure", size: "2.4 MB" },
    { title: "Product Portfolio 2024", size: "3.1 MB" },
  ],
  pamphlets: [
    { title: "solar C012 Quick Guide", size: "1.2 MB" },
            ...
            <div className="container mx-auto px-6">
              <ScrollReveal className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                  Access patents, certifications, case studies, and downloadable materials to support your journey with solar.
                </p>
              </ScrollReveal>
            </div>
          </section>
