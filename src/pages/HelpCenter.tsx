    ...
    return (
        <>
            <main className="pt-24 min-h-screen bg-white">
                    ...
                    <div className="container mx-auto px-6">
                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                            ...
                            <div className="flex flex-col gap-4 text-right">
                                <Link to="/faqs" className="text-[#00ffff] font-medium hover:underline">FAQs</Link>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-[#00FFFF] py-20 min-h-[60vh] flex items-center justify-center relative">
                    <div className="container mx-auto px-6 w-full">
                        {/* White Info Card */}
                        <ScrollReveal>
                            <div className="bg-white rounded-[2rem] shadow-2xl p-8 md:p-12 relative z-10 border border-slate-100 mx-auto">
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 divide-y md:divide-y-0 md:divide-x divide-slate-100">
                                    ...
                                    <div className="flex flex-col items-center md:items-start space-y-4 pt-8 md:pt-0 md:pr-8">
                                        <p className="text-xs font-semibold text-[#00e6ff] uppercase tracking-wider">
                                    ...
                                    <div className="flex flex-col items-center md:items-start space-y-4 pt-8 md:pt-0 md:px-8">
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-3xl md:text-4xl text-slate-400">11 AM - 6 PM</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center md:items-start space-y-4 pt-8 md:pt-0 md:pl-8">
                                        ...
                                        <div className="space-y-6 w-full">
                                            ...
                                            <motion.button
                                                ...
                                                whileTap={{ scale: 0.98 }}
                                                className="w-full md:w-auto px-8 py-4 bg-[#00FFFF] text-white rounded-xl font-bold text-sm hover:bg-[#4ffafa] transition-all uppercase tracking-widest shadow-md"
