    ...
    return (
        ...
        >
            <motion.div
                ...
                className="relative w-full max-w-7xl mx-4 bg-white rounded-2xl shadow-2xl"
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={(e) => setFormData({ ...formData, query: e.target.value })} // Handling change directly here or via generic handler if updated
