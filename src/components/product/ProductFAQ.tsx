...
const productFaqs = [
    {
        question: "How accurate are SUNBOT's portable analyzers?",
    ...
    },
    {
        ...
        answer: "No. SUNBOT devices are designed for 'precision simplified'. Most users can learn to perform tests in less than 30 minutes. We also provide comprehensive on-site and remote training as part of our deployment support."
    },
    {
        question: "Are the products compatible with mobile apps?",
        answer: "Yes, all our recent devices feature IoT connectivity via LoRa, Bluetooth, or GSM. Data is automatically synced to the SUNBOT dashboard, and real-time alerts can be received on mobile devices and via email."
    },
    {
