  ...
  "cluix-c012": {
    ...
    testimonials: {
      ...
      items: [
        ...
        {
          quote:
            "The accuracy matches our lab instruments, but we can now test at source. It's a game-changer for our compliance monitoring.",
          role: "Environmental Officer",
          organization: "Pharmaceutical Company, Gujarat",
        },
        {
          quote:
            "Finally, a device that works in Indian field conditions. Rugged, fast, and the support team is excellent.",
          role: "Program Lead",
    ...
    deploymentSupport: {
      ...
      description:
        "We provide end-to-end deployment support including device setup, calibration, user training, and ongoing technical assistance. Our team ensures you get maximum value from your C012 investment.",
      features: [
  ...
  ocems: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote:
            "OCEMS installation was seamless. We're now fully compliant and the automated reporting saves us hours every month.",
          role: "Plant Manager",
    ...
    deploymentSupport: {
      title: "Deployment & Support",
      description:
        "Complete turnkey installation including sensors, analyzers, data logger, and CPCB/SPCB integration. Our team handles everything from site survey to commissioning.",
      features: [
  ...
  varunaa: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote:
            "We monitor 50+ borewells across the district. Varunaa has made groundwater management truly data-driven.",
          role: "District Geologist",
          organization: "CGWB, Karnataka",
        },
        {
          quote:
            "The solar power and LoRa connectivity work perfectly in our remote farm. No maintenance for 2 years now.",
          role: "Farm Owner",
    ...
    deploymentSupport: {
      title: "Deployment & Support",
      description:
        "Quick installation with minimal site preparation. Solar-powered units require no external power. Our network covers most of India for LoRa/GSM connectivity.",
      features: [
      ...
      formTitle: "Get a Quote",
      formSubtitle:
        "Interested in Varunaa for groundwater monitoring? Fill out the form and our team will get back to you.",
    },
  },
  "reagent-kit": {
    id: "reagent-kit",
